...
A complete decompilation of Retro Engine v4 and the menus from Sonic 1 and 2 (2013) for PS3.
...
+ You can get official releases of Sonic 1 & Sonic 2 from:
  ...
  * Scripts
    * [RSDKv4 Script Decompilation](https://github.com/RSDKModding/RSDKv4-Script-Decompilation)
...
* For the **PlayStation 3**, go to [DropSonic0's fork](https://github.com/DropSonic0/RSDKv4-PS3).
...
# PS3 Servers
HOST requires UPnP enabled and CGNAT disabled.
To use JOIN, you only need to be connected to the internet.
